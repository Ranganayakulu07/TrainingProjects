...
public class login {
	...
	public void enter_bus_details() throws InterruptedException {
		  ...
		  jse.executeScript("document.getElementById('txtJourneyDate').value='20/09/2021'");
		  jse.executeScript("document.getElementById('txtReturnJourneyDate').value='22/09/2021'");
		  Thread.sleep(5000);
